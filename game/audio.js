...
const Audio = (() => {
  ...
  const OOMPAH_PATTERNS = [
    ...
    // Bar 1 – C chord
    [130.8, 'sawtooth', 0.35, 0.08, 0.0],   // C2 bass
    [261.6, 'square',   0.25, 0.04, 0.5],   // C3 chord
    [329.6, 'square',   0.25, 0.04, 0.5],
    [392.0, 'square',   0.25, 0.04, 0.5],
    [261.6, 'square',   0.25, 0.04, 1.0],
    [329.6, 'square',   0.25, 0.04, 1.0],
    [392.0, 'square',   0.25, 0.04, 1.0],
    // Bar 2 – G chord
    [98.0,  'sawtooth', 0.35, 0.08, 1.5],    // G1 bass
    [196.0, 'square',   0.25, 0.04, 2.0],
    [246.9, 'square',   0.25, 0.04, 2.0],
    [293.7, 'square',   0.25, 0.04, 2.0],
    [196.0, 'square',   0.25, 0.04, 2.5],
    [246.9, 'square',   0.25, 0.04, 2.5],
    [293.7, 'square',   0.25, 0.04, 2.5],
    // Bar 3 – F chord
    [174.6, 'sawtooth', 0.35, 0.08, 3.0],
    [261.6, 'square',   0.25, 0.04, 3.5],
    [349.2, 'square',   0.25, 0.04, 3.5],
    [392.0, 'square',   0.25, 0.04, 3.5],
    [261.6, 'square',   0.25, 0.04, 4.0],
    [349.2, 'square',   0.25, 0.04, 4.0],
    [392.0, 'square',   0.25, 0.04, 4.0],
    // Bar 4 – G → C resolve
    [98.0,  'sawtooth', 0.35, 0.08, 4.5],
    [196.0, 'square',   0.25, 0.04, 5.0],
    [246.9, 'square',   0.25, 0.04, 5.0],
    [293.7, 'square',   0.25, 0.04, 5.0],
    [130.8, 'sawtooth', 0.35, 0.08, 5.5],
    [261.6, 'square',   0.25, 0.04, 6.0],
    [329.6, 'square',   0.25, 0.04, 6.0],
    [392.0, 'square',   0.25, 0.04, 6.0],
  ];
